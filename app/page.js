  ...
  return (
    <>
      <div className="flex justify-center flex-col gap-4 items-center text-white h-[44vh] px-5 md:px-0 text-xs md:text-base  ">
        <div className="font-bold flex gap-6 md:text-5xl justify-center items-center text-3xl">Get Me a Coffee 
          <span><img className="invertImg md:size-24" src="/tea.gif" width={52}  alt="" /></span></div>
  ...
  <div className="flex gap-5 justify-around">
    ...
    <div className="item space-y-3 flex flex-col items-center justify-center">
      ...
      <div className="text-white container mx-auto pb-32 pt-14 flex flex-col items-center justify-center">
        <h2 className="text-3xl font-bold text-center mb-14">Vist my cringe YouTube Videos</h2>
