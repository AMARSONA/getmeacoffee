    ...
    return (
        <nav className='bg-gray-900 shadow-xl shadow-white text-white flex justify-between items-center px-4 md:h-16'>
            ...
            <Link href={"/"} className='logo font-bold text-lg flex justify-center items-center'>
                ...
                <span className='text-xl md:text-base my-3 md:my-0'>GetMeACoffee</span></Link>
            ...
            <div className='relative flex justify-center items-center  md:block gap-4'>
                {session && <>
                    ...
                    }} data-dropdown-toggle="dropdown" className=" mx-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 
                    text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Account {/*Welcome session.user.email*/} <svg className="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
